...
describe UsersController do
  describe "routing" do
    ...
    it "recognizes and generates #login" do
      { :get => "/" }.should route_to(:controller => "users", :action => "login")
    end

    it "recognizes and generates #verify_login" do
      { :post => "/users/verify_login" }.should route_to(:controller => "users", :action => "verify_login")
    end

    it "recognizes and generates #home_page" do
      { :get => "/users/home_page" }.should route_to(:controller => "users", :action => "home_page")
    end
